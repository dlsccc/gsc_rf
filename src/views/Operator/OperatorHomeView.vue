  ...
  <div class="function-menu" style="margin-top: 64px;">
    <div class="menu-header">
      ...
      <div class="menu-title-area">
        <div class="menu-title">
          ...
          <span class="role-badge operator">{{ TEXT.role }}</span>
        </div>
        <div class="menu-subtitle">{{ TEXT.subtitle }}</div>
      </div>
    </div>
    ...
    <div class="function-cards">
      <div class="function-card" @click="openLakeExecute">
        ...
        <div class="function-name">{{ TEXT.lakeTitle }}</div>
        <div class="function-desc">{{ TEXT.lakeDesc }}</div>
      </div>
      ...
      <div class="function-card" @click="openReportGeneration">
        ...
        <div class="function-name">{{ TEXT.reportTitle }}</div>
        <div class="function-desc">{{ TEXT.reportDesc }}</div>
      </div>
      ...
      <div class="function-card" @click="openReportHistory">
        ...
        <div class="function-name">{{ TEXT.reportHistoryTitle }}</div>
        <div class="function-desc">{{ TEXT.reportHistoryDesc }}</div>
      </div>
    </div>
  </div>
</template>
...
const TEXT = {
  title: '\u4f5c\u4e1a\u6267\u884c\u4eba\u5458\u5de5\u4f5c\u53f0',
  role: '\u4f5c\u4e1a\u6267\u884c\u4eba\u5458',
  subtitle: '\u6267\u884c\u6570\u636e\u5165\u6e56\u4e0e\u62a5\u544a\u751f\u6210\u4efb\u52a1',
  lakeTitle: '\u6570\u636e\u5165\u6e56',
  lakeDesc: '\u9009\u62e9\u5165\u6e56\u89c4\u5219\uff0c\u6267\u884c\u6570\u636e\u5165\u6e56\u4efb\u52a1',
  reportTitle: '\u62a5\u544a\u751f\u6210',
  reportDesc: '\u9009\u62e9\u62a5\u544a\u6a21\u677f\uff0c\u751f\u6210\u6570\u636e\u62a5\u544a',
  reportHistoryTitle: '\u62a5\u544a\u751f\u6210\u8bb0\u5f55',
  reportHistoryDesc: '\u67e5\u770b\u5386\u53f2\u62a5\u544a\u751f\u6210\u8bb0\u5f55'
};
